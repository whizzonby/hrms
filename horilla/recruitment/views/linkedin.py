...
def check_linkedin(request):
    ...
    code = request.GET.get("code") or os.environ.get("LINKEDIN_OAUTH_CODE", "")
    client_id = getattr(settings, "LINKEDIN_CLIENT_ID", None) or os.environ.get("LINKEDIN_CLIENT_ID", "")
    client_secret = getattr(settings, "LINKEDIN_CLIENT_SECRET", None) or os.environ.get("LINKEDIN_CLIENT_SECRET", "")
    redirect_uri = getattr(settings, "LINKEDIN_REDIRECT_URI", None) or os.environ.get("LINKEDIN_REDIRECT_URI", "https://www.linkedin.com/developers/tools/oauth/redirect")
    data = {
